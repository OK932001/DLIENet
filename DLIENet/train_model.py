...
parser.add_argument('--savePath', type=str, default='./output/output_model', help='weight save path')
parser.add_argument('--dataroot', type=str, default='./dataset', help='root directory of the dataset')
parser.add_argument('--model_name', type=str, default='mode', help='root directory of the dataset')
