...
from model1020 import Discriminator
...
parser.add_argument('--savePath', type=str, default='./output/output20221105', help='weight save path')
parser.add_argument('--dataroot', type=str, default='./dataset', help='root directory of the dataset')
parser.add_argument('--model_name', type=str, default='model1020', help='root directory of the dataset')
