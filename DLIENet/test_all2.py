...
from model1020 import Generator
...
parser.add_argument('--model_name', type=str, default='model1020', help='size of the batches')
parser.add_argument('--generator_path', type=str, default='./output/output20221020')
parser.add_argument('--order', type=str, default='2', help='save path number file')
...
#print(glob(opt.generator_path + '/*.pth'))
print("执行120行")
...
while(index_num<len(files_A)):
    ...
    for i, batch in enumerate(dataloader):
        ...
        # Generate output
        fake_B = 0.5 * (netG_A2B(real_A)[2].data + 1.0)
        fake_A = 0.5 * (netG_B2A(real_B)[2].data + 1.0)
