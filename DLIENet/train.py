...
for epoch in range(opt.epoch, opt.n_epochs):
    ...
    torch.save(netG_A2B.state_dict(), './output/2022091801/netG_A2B.pth')
    torch.save(netG_B2A.state_dict(), './output/2022091801/netG_B2A.pth')
    torch.save(netD_A.state_dict(), './output/2022091801/netD_A.pth')
    torch.save(netD_B.state_dict(), './output/2022091801/netD_B.pth')
###################################
